...
margin:0;
padding:0;
background-image:linear-gradient(rgba(0,0,0,0.2),rgba(0,0,0,0.2)),url(images/istockphoto-533850129-612x612.jpg);
...
<!--form-->
  <form class="sign-up " action="a_add_vacancy.php"  method="POST"  enctype="multipart/form-data" style="margin-left: 400px;">
