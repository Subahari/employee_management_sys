...
<head>
    ...
    <title>Applicant's Feedback</title>
...
<style>
    #contact {
		...
		background-image:linear-gradient(rgba(0,0,0,0.2),rgba(0,0,0,0.2)),url(images/asdfg.png);
		background-size:cover;
background-position:center;
...
<a href="aboutus.php" class="dropbtn" style="float:right">Return Back</a>
<section id="contact">
...
<?php
    ...
    $result=$mysqli->query("SELECT * from comments order by comment_id  asc") or die($mysqli->error);
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <img src="images/profile.png" style="float: left;" /> <h5 class="card-title"><?php echo $row['comment_sender_name'];?></h5>
                    <p class="card-text"><?php echo $row['comment'];?></p>
                    <div class="card-footer">
                        <small class="text-muted"><i class="fa fa-calendar"></i> <?php echo $row['date'];?></small>
                    </div>
